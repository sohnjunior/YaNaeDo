...
class Korean(object):
    str_base_code, str_onset_offset, str_nucleus_offset = 44032, 588, 28
    ...
    class Syllable(object):
        ...
        def combine(self):
            ...
            try:
                ...
                if phoneme_onset and not phoneme_nucleus and not phoneme_coda:
                    ...
                    self.letter = chr(code + Korean.str_base_code)
        ...
        def decompose(self):
            ...
            base_code = ord(self.letter) - Korean.str_base_code
            ...
            c1 = base_code // Korean.str_onset_offset
            self.phoneme_onset = Korean.phoneme_onset_list[c1]

            c2 = (base_code - (Korean.str_onset_offset * c1)) // Korean.str_nucleus_offset
            self.phoneme_nucleus = Korean.phoneme_nucleus_list[c2]

            c3 = (base_code - (Korean.str_onset_offset * c1) - (Korean.str_nucleus_offset * c2))
